(define (problem Problem3)
	...
	(:init
		...
		(package-at Package2 c0_0_0)
		(package-at Package3 c0_0_0)
		(person-at Person1 c2_0_0)
		(person-at Person2 c1_1_0)
		(person-at Person3 c2_2_0)
	...
	(:goal (and 
			...
			(picture-taken Person2 Package2)
			(picture-taken Person3 Package3)
			(quad-at-base Quad Base))
	)
